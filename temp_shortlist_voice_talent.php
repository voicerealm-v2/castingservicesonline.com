...
if(isset($_GET['temp_audition'])){
		$cond_initial				=	"advertiser_id='".$adv_id."' AND job_id='".$_GET['temp_audition']."' AND fav_type='T'";
	...
	$cond_initial				=	"FAV_ADVERTISER_ID='".$adv_id."' AND FAV_TYPE='T'";
...
<!--changes by aparna 2-2-2019 http to https-->
